...
export interface AppMetadata { schemaVersion: number; lastRolloverDate?: string | null; lastRolloverWeek?: string | null; activeTaskId?: string | null; dismissedFocusDate?: string | null; }
